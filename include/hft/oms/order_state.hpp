...
class OmsState {
public:
    void on_command_sent(const execution::OrderCommand& cmd);
    void on_command_rejected(const execution::OrderCommand& cmd);
    void on_command_acked(const execution::OrderCommand& cmd);
