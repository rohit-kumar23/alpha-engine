...
RiskRejectReason PreTradeRisk::validate(const ordermgmt::OrderCommand& cmd) const {
...
void PreTradeRisk::on_fill(marketdata::Instrument instrument, double signed_qty) {
...
std::size_t PreTradeRisk::idx(marketdata::Instrument instrument) const {
